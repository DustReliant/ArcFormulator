...
public:
    ...
    enum ConfigFlag
    {
        ...
        DefaultDockAreaButtons =
                DockAreaHasCloseButton | DockAreaHasUndockButton | DockAreaHasTabsMenuButton,
...
public:
    ...
    addAutoHideDockWidgetToContainer(SideBarLocation location, QdfDockWidget *dockWidget,
                                     QdfDockContainerWidget *DockContainerWidget);

    QdfDockAreaWidget *addDockWidgetTab(DockWidgetArea area, QdfDockWidget *dockWidget);
