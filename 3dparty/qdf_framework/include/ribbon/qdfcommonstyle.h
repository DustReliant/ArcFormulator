#ifndef DESKTOPFRAMEWORK_QDFCOMMONSTYLE_H
#define DESKTOPFRAMEWORK_QDFCOMMONSTYLE_H
...
class QdfCommonStylePrivate;
class QdfCommonPaintManager;
...
/* QdfCommonStyle */
#if (QT_VERSION >= QT_VERSION_CHECK(5, 0, 0))
class QDF_EXPORT QdfCommonStyle : public QCommonStyle
#else
class QDF_EXPORT QdfCommonStyle : public QWindowsStyle
#endif
{
    Q_OBJECT
public:
...
protected:
    QdfCommonStyle(QdfCommonStylePrivate *d);
    virtual ~QdfCommonStyle();

public:
    QColor getThemeColor(const QString &sectionName, const QString &keyName,
...
protected:
    ...
    virtual bool drawFrameMenu(const QStyleOption *, QPainter *, const QWidget *) const
    {
        return false;
    }
    ...
    virtual bool drawIndicatorViewItemCheck(PrimitiveElement, const QStyleOption *, QPainter *,
                                            const QWidget *) const
    {
        return false;
    }
    ...
    virtual bool drawSlider(const QStyleOptionComplex *, QPainter *, const QWidget *) const
    {
        return false;
    }

    // for ScrollBar
    virtual bool drawScrollBar(const QStyleOptionComplex *, QPainter *, const QWidget *) const
    {
        return false;
    }
    virtual bool drawScrollBarLine(ControlElement, const QStyleOption *, QPainter *,
                                   const QWidget *) const
    {
        return false;
    }
    ...
    virtual bool drawScrollBarPage(ControlElement, const QStyleOption *, QPainter *,
                                   const QWidget *) const
    {
        return false;
    }
    ...
    // for editors
    virtual bool drawControlEdit(const QStyleOption *, QPainter *, const QWidget *) const
    {
        return false;
    }
    ...
    virtual bool drawComboBox(const QStyleOptionComplex *, QPainter *, const QWidget *) const
    {
        return false;
    }
    ...
    virtual bool drawIndicatorDockWidgetResizeHandle(const QStyleOption *, QPainter *,
                                                     const QWidget *) const
    {
        return false;
    }
    ...
    // for ComboBox
    virtual bool drawComboBoxLabel(ControlElement, const QStyleOption *, QPainter *,
                                   const QWidget *) const
    {
        return false;
    }
    ...
    virtual void drawRectangle(QPainter *, const QRect &, bool, bool, bool, bool, bool, BarType,
                               BarPosition) const
    {
    }

    QdfCommonPaintManager *paintManager() const;
...
protected:
    ...
    void clearCache();
    void drawImagePart(const QPixmap &dcSrc, QPainter &p, const QRect &rcDest, const QRect &rcSrc,
                       bool bAlpha) const;
    ...
    void drawImage(const QPixmap &dcSrc, QPainter &p, const QRect &rcDest, const QRect &rcSrc,
                   ...
                   bool alphaBlend = false) const;

    void drawPixmap(const QPixmap &dcSrc, QPainter &p, const QRect &rcDest, const QRect &rcSrc,
                    bool alpha, QRect rcSizingMargins = QRect(QPoint(0, 0), QPoint(0, 0)),
                    bool alphaBlend = false) const;
...
protected:
    QDF_DECLARE_PRIVATE(QdfCommonStyle)
private:
    friend class QdfCommonPaintManager;
    Q_DISABLE_COPY(QdfCommonStyle)
};

QDF_END_NAMESPACE

#endif//DESKTOPFRAMEWORK_QDFCOMMONSTYLE_H