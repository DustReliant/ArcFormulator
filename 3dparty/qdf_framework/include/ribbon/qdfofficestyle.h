...
public:
    ...
    virtual int pixelMetric(PixelMetric pm, const QStyleOption *option = nullptr,
                            const QWidget *widget = nullptr) const;
...
protected:
    ...
    virtual bool drawIndicatorCheckRadioButton(PrimitiveElement element, const QStyleOption *,
    ...
    virtual bool drawScrollBarPage(ControlElement element, const QStyleOption *, QPainter *,
                                   const QWidget *) const;
    // for editors
    ...
    virtual QColor getTextColor(bool selected, bool pressed, bool enabled, bool checked, bool popuped,
