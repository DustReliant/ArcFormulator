...
{
public:
    explicit QdfRibbonCheckBoxControl(const QString &text = QString(),
                                      QdfRibbonGroup *parentGroup = nullptr);
...
{
public:
    explicit QdfRibbonRadioButtonControl(const QString &text = QString(),
                                         QdfRibbonGroup *parentGroup = nullptr);
