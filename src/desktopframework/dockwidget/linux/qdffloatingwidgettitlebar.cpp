...
void QdfFloatingWidgetTitleBarPrivate::createLayout()
{
    ...
    QIcon CloseIcon;
    QPixmap normalPixmap = q->style()->standardPixmap(QStyle::SP_TitleBarCloseButton, 0, CloseButton);
    CloseIcon.addPixmap(normalPixmap, QIcon::Normal);
    CloseIcon.addPixmap(internal::createTransparentPixmap(normalPixmap, 0.25), QIcon::Disabled);
    CloseButton->setIcon(q->style()->standardIcon(QStyle::SP_TitleBarCloseButton));
...
QdfFloatingWidgetTitleBar::QdfFloatingWidgetTitleBar(QdfFloatingDockContainer *parent)
    : QFrame(parent), d(new QdfFloatingWidgetTitleBarPrivate(this))
{
    d->FloatingWidget = parent;
    d->createLayout();

    auto normalPixmap =
            this->style()->standardPixmap(QStyle::SP_TitleBarNormalButton, 0, d->MaximizeButton);
