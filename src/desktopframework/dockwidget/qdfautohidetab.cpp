...
void QdfAutoHideTabPrivate::updateOrientation()
{
    ...
    else
    {
        ...
        q->setOrientation((area == SideBarLocation::SL_Bottom || area == SideBarLocation::SL_Top)
                                  ? Qt::Horizontal
                                  : Qt::Vertical);
    }
}
...
QdfAutoHideTab::QdfAutoHideTab(QWidget *parent) : QPushButton(parent)
{
...
void QdfAutoHideTab::setOrientation(Qt::Orientation Orientation)
{
    ...
    setButtonOrientation((Qt::Horizontal == Orientation) ? QdfAutoHideTab::Horizontal
...
{
    return QdfDockManager::testAutoHideConfigFlag(QdfDockManager::AutoHideSideBarsIconOnly) &&
           !icon().isNull();
}