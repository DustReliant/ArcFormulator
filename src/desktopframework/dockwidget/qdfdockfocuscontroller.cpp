...
void QdfDockFocusControllerPrivate::updateDockWidgetFocus(QdfDockWidget *dockWidget)
{
    ...
    if (window)
    {
        window->setProperty(FocusedDockWidgetProperty,
                            QVariant::fromValue(QPointer<QdfDockWidget>(dockWidget)));
    }
    ...
    if (newFocusedDockArea && (focusedArea != newFocusedDockArea))
    {
        if (focusedArea)
        {
            QObject::disconnect(focusedArea, SIGNAL(viewToggled(bool)), q,
        ...
        QObject::connect(focusedArea, SIGNAL(viewToggled(bool)), q,
                         SLOT(onFocusedDockAreaViewToggled(bool)));
    }
    ...
    else
    {
        ...
        QObject::connect(dockWidget, SIGNAL(visibilityChanged(bool)), q,
...
QdfDockFocusController::QdfDockFocusController(QdfDockManager *dockManager) : QObject(dockManager)
{
