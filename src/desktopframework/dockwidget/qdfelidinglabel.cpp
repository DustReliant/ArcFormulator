...
QdfElidingLabel::QdfElidingLabel(QWidget *parent, Qt::WindowFlags flag) : QLabel(parent, flag)
{
    QDF_INIT_PRIVATE(QdfElidingLabel);
}


QdfElidingLabel::QdfElidingLabel(const QString &text, QWidget *parent, Qt::WindowFlags flag)
    : QLabel(text, parent, flag)
{
    QDF_INIT_PRIVATE(QdfElidingLabel)
...
QdfElidingLabel::~QdfElidingLabel(){QDF_FINI_PRIVATE()}
