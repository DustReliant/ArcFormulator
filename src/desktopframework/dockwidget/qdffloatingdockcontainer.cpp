...
#endif
{
    ...
    if (native_window)
    {
        ...
        setWindowFlags(Qt::Window | Qt::WindowMaximizeButtonHint | Qt::CustomizeWindowHint |
    ...
    else
    {
        ...
        connect(d->TitleBar, &QdfFloatingWidgetTitleBar::maximizeRequested, this,
                &QdfFloatingDockContainer::onMaximizeRequest);
    }
#else
...
void QdfFloatingDockContainer::startFloating(const QPoint &dragStartMousePos, const QSize &size,
...
{
    QDF_D(const QdfFloatingDockContainer)
    return d->dockContainer->features().testFlag(QdfDockWidget::DockWidgetClosable);
}
