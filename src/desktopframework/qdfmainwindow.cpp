...
QdfMainWindow::QdfMainWindow(QWidget *parent, Qt::WindowFlags flags) : QMainWindow(parent, flags)
{
...
void QdfMainWindow::setRibbonBar(QdfRibbonBar *ribbonBar)
{
