...
public:
    Qt::AlignmentFlag alignmentLogotype() const
    {
        return m_alignment;
    }
    void setAlignmentLogotype(Qt::AlignmentFlag alignment)
    {
...
public:
    ...
    void createWidgetKeyTips(QdfRibbonGroup *group, QWidget *widget, const QString &prefix,
