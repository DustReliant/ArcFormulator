...
public:
    ...
    bool collapseGroups(int &leftOffset, int actualWidth, QdfRibbonControlSizeDefinition::GroupSize size,
                        bool adjust);
    bool expandGroups(int &leftOffset, int actualWidth, QdfRibbonControlSizeDefinition::GroupSize size,
                      bool adjust);
