...
QdfRibbonButtonControl::QdfRibbonButtonControl(QdfRibbonGroup *parentGroup)
...
QdfRibbonButtonControl::~QdfRibbonButtonControl()
{
    QDF_FINI_PRIVATE();
}
...
void QdfRibbonButtonControl::setToolButtonStyle(Qt::ToolButtonStyle style)
{
    ...
    if (style == Qt::ToolButtonIconOnly)
    {
        ...
        sizeDefinition(QdfRibbonControlSizeDefinition::GroupMedium)
                ->setImageSize(QdfRibbonControlSizeDefinition::ImageSmall);
        sizeDefinition(QdfRibbonControlSizeDefinition::GroupMedium)->setLabelVisible(false);
        sizeDefinition(QdfRibbonControlSizeDefinition::GroupSmall)
                ->setImageSize(QdfRibbonControlSizeDefinition::ImageSmall);
        sizeDefinition(QdfRibbonControlSizeDefinition::GroupSmall)->setLabelVisible(false);
        sizeDefinition(QdfRibbonControlSizeDefinition::GroupPopup)
                ->setImageSize(QdfRibbonControlSizeDefinition::ImageSmall);
    ...
    {
        sizeDefinition(QdfRibbonControlSizeDefinition::GroupLarge)
                ->setImageSize(QdfRibbonControlSizeDefinition::ImageNone);
...
QCheckBox *QdfRibbonCheckBoxControl::widget() const
{
    return qobject_cast<QCheckBox *>(contentWidget());
}

QdfRibbonRadioButtonControl::QdfRibbonRadioButtonControl(const QString &text,
                                                         QdfRibbonGroup *parentGroup)
    : QdfRibbonWidgetControl(parentGroup, true)
{
...
QRadioButton *QdfRibbonRadioButtonControl::widget() const
{
