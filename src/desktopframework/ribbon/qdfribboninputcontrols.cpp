...
QFontComboBox *QdfRibbonFontComboBoxControl::widget() const
{
...
QLineEdit *QdfRibbonLineEditControl::widget() const
{
...
QComboBox *QdfRibbonComboBoxControl::widget() const
{
...
QSpinBox *QdfRibbonSpinBoxControl::widget() const
{
...
QDoubleSpinBox *QdfRibbonDoubleSpinBoxControl::widget() const
{
...
QSlider *QdfRibbonSliderControl::widget() const
{
...
QdfRibbonSliderPane *QdfRibbonSliderPaneControl::widget() const
{
    return qobject_cast<QdfRibbonSliderPane *>(contentWidget());
}
...
QDateTimeEdit *QdfRibbonDateTimeEditControl::widget() const
{
...
QTimeEdit *QdfRibbonTimeEditControl::widget() const
{
...
QDateEdit *QdfRibbonDateEditControl::widget() const
{
