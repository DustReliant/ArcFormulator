...
void QdfDockContainerWidgetPrivate::dropIntoCenterOfSection(
        QdfFloatingDockContainer *floatingWidget, QdfDockAreaWidget *targetArea)
{
                                                    ...
                                                    QdfDockAreaWidget *targetArea, DockWidgetArea area)
{
    ...
    QdfDockContainerWidget *floatingContainer = floatingWidget->dockContainer();
    auto insertParam = internal::dockAreaInsertParameters(area);
    auto NewDockAreas = floatingContainer->findChildren<QdfDockAreaWidget *>(
            QString(), Qt::FindChildrenRecursively);
...
void QdfDockContainerWidgetPrivate::moveIntoCenterOfSection(QWidget *widget, QdfDockAreaWidget *targetArea)
{
...
void QdfDockContainerWidgetPrivate::moveToNewSection(QWidget *widget, QdfDockAreaWidget *targetArea, DockWidgetArea area)
{
    QDF_Q(QdfDockContainerWidget)
    if (CenterDockWidgetArea == area)
    {
...
void QdfDockContainerWidgetPrivate::appendDockAreas(const QList<QdfDockAreaWidget *> newDockAreas)
{
    ...
    for (auto &dockArea: newDockAreas)
    {
        QObject::connect(dockArea,
                         &QdfDockAreaWidget::viewToggled,
                         q,
                         std::bind(&QdfDockContainerWidgetPrivate::onDockAreaViewToggled, this, std::placeholders::_1));
    }
}
...
QdfDockAreaWidget *QdfDockContainerWidgetPrivate::addDockWidgetToDockArea(DockWidgetArea area,
                                                                          QdfDockWidget *dockwidget, QdfDockAreaWidget *targetDockArea, int Index)
{
    QDF_Q(QdfDockContainerWidget)
    if (CenterDockWidgetArea == area)
    {
...
QdfAutoHideDockContainer *QdfDockContainerWidget::createAndSetupAutoHideContainer(
        SideBarLocation area, QdfDockWidget *dockWidget)
{
    QDF_D(QdfDockContainerWidget)
...
void QdfDockContainerWidget::dropWidget(QWidget *widget, DockWidgetArea dropArea, QdfDockAreaWidget *targetAreaWidget)
{
    QDF_D(QdfDockContainerWidget)
    QdfDockWidget *singleDockWidget = topLevelDockWidget();
    if (targetAreaWidget)
