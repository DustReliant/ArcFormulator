...
QdfOfficePaintManager::QdfOfficePaintManager(QdfCommonStyle *baseStyle) : QdfCommonPaintManager(baseStyle)
{
    loadPixmap();
...
QdfOfficeStyle::Theme QdfOfficePaintManager::theme() const { return ((QdfOfficeStyle *) baseStyle())->getTheme(); }
...
QColor QdfOfficePaintManager::textColor(bool selected, bool pressed, bool enabled, bool checked, bool popuped,
...
QIcon QdfOfficePaintManager::standardIconEx(QStyle::StandardPixmap px, const QStyleOption *opt, const QWidget *wd,
                                            bool &ret) const
{
    Q_UNUSED(px);
    Q_UNUSED(opt);
...
QColor QdfOfficePaintManager::menuLabelColor() const { return m_clrBarShadow; }

void QdfOfficePaintManager::drawSysButton(QPainter *p, const QRect &rect, bool down, bool highlighted) const
{
...
bool QdfOfficePaintManager::drawTitleBar(const QStyleOptionComplex *opt, QPainter *p, const QWidget *wd) const
{
...
bool QdfOfficePaintManager::drawIndicatorToolBarSeparator(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    Q_UNUSED(opt);
    Q_UNUSED(p);
...
bool QdfOfficePaintManager::drawIndicatorMenuCheckMark(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    QRect rc = opt->rect;
    ...
    ImageIcons iImage = /*isRadio*/ false ? QdfOfficePaintManager::Icon_Radio : QdfOfficePaintManager::Icon_Check;
...
bool QdfOfficePaintManager::drawIndicatorCheckRadioButton(QStyle::PrimitiveElement element, const QStyleOption *option,
                                                          QPainter *p, const QWidget *widget) const
{
    ...
    if (isRadio)
    {
        ...
        QColor clrBorder = !enabled ? m_clrBarShadow : (highlighted || pressed) ? m_clrHighlightDn
                                                                                : m_clrBarDkShadow;
        p->setPen(clrBorder);
        p->drawPath(circle);
...
bool QdfOfficePaintManager::drawIndicatorViewItemCheck(QStyle::PrimitiveElement element, const QStyleOption *option,
                                                       QPainter *painter, const QWidget *widget) const
{
    return drawIndicatorCheckRadioButton(element, option, painter, widget);
}

bool QdfOfficePaintManager::drawPanelButtonCommand(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    QDF_D_STYLE(QdfOfficeStyle)
...
bool QdfOfficePaintManager::drawPanelTipLabel(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w)
...
bool QdfOfficePaintManager::drawControlEdit(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
    QDF_D_STYLE(QdfOfficeStyle)
...
bool QdfOfficePaintManager::drawFrameLineEdit(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    QDF_D_STYLE(QdfOfficeStyle)
    if (const QStyleOptionFrame *panel = qstyleoption_cast<const QStyleOptionFrame *>(opt))
...
bool QdfOfficePaintManager::drawComboBox(const QStyleOptionComplex *opt, QPainter *p, const QWidget *w) const
{
    QDF_D_STYLE(const QdfOfficeStyle)
...
bool QdfOfficePaintManager::drawSpinBox(const QStyleOptionComplex *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    QDF_D_STYLE(const QdfOfficeStyle)
    ...
    if (const QStyleOptionSpinBox *sb = qstyleoption_cast<const QStyleOptionSpinBox *>(opt))
    {
        ...
        if (sb->subControls & QStyle::SC_SpinBoxUp)
        {
            ...
            drawIcon(p, rcTop, index[false ? 1 : 0][0],
                     enabledIndicator ? QdfOfficePaintManager::Black : QdfOfficePaintManager::Gray, QSize(9, 9));
        }
...
bool QdfOfficePaintManager::drawToolBoxTabShape(const QStyleOption *, QPainter *, const QWidget *) const { return false; }

bool QdfOfficePaintManager::drawTabBarTabShape(const QStyleOption *option, QPainter *p, const QWidget *widget) const
{
...
bool QdfOfficePaintManager::drawIndicatorTabClose(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
                ...
                case QFrame::Panel:
                    {
                        if (frameShadow == QFrame::Sunken)
                        {
                            ...
                            if (QTabBar *tabBar = mdiArea->findChild<QTabBar *>())
                            {
                                ...
                                QdfDrawHelpers::draw3dRectEx(*p, rect, m_clrBarDkShadow, m_clrBarDkShadow);
                            }
                            ret = true;
                        }
                        break;
...
bool QdfOfficePaintManager::drawFrameWindow(const QStyleOption *opt, QPainter *p, const QWidget *wd) const
{
    QDF_D_STYLE(const QdfOfficeStyle)
    if (!wd || !qobject_cast<const QMdiSubWindow *>(wd))
    {
...
bool QdfOfficePaintManager::drawScrollBar(const QStyleOptionComplex *opt, QPainter *p, const QWidget *w) const
{
    QDF_D_STYLE(const QdfOfficeStyle)
...
bool QdfOfficePaintManager::drawScrollBarLine(QStyle::ControlElement element, const QStyleOption *opt, QPainter *p,
                                              const QWidget *w) const
{
    Q_UNUSED(w);
    ...
    if (const QStyleOptionSlider *scrollbar = qstyleoption_cast<const QStyleOptionSlider *>(opt))
    {
        ...
        */
        ...
        QdfOfficePaintManager::ImageState state = enabled ? stateByColor(clrFill, true) : QdfOfficePaintManager::Gray;
...
bool QdfOfficePaintManager::drawScrollBarSlider(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
...
bool QdfOfficePaintManager::drawScrollBarPage(QStyle::ControlElement element, const QStyleOption *opt, QPainter *p,
                                              const QWidget *w) const
{
    Q_UNUSED(element);
    Q_UNUSED(opt);
...
// for stausBar
bool QdfOfficePaintManager::drawPanelStatusBar(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
...
// for ViewItem
bool QdfOfficePaintManager::drawPanelItemViewItem(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(opt);
    Q_UNUSED(p);
    Q_UNUSED(w);
...
bool QdfOfficePaintManager::drawHeaderSection(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
...
bool QdfOfficePaintManager::drawHeaderEmptyArea(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    p->fillRect(opt->rect, m_clrBarFace);
...
bool QdfOfficePaintManager::drawIndicatorHeaderArrow(const QStyleOption *, QPainter *, const QWidget *) const
{
    return false;
}

bool QdfOfficePaintManager::drawIndicatorArrow(QStyle::PrimitiveElement pe, const QStyleOption *opt, QPainter *p,
                                               const QWidget *w) const
{
    Q_UNUSED(w);
    switch (pe)
...
bool QdfOfficePaintManager::drawGalleryToolButton(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
    QDF_D_STYLE(const QdfOfficeStyle)
    if (const QStyleOptionToolButton *toolbutton = qstyleoption_cast<const QStyleOptionToolButton *>(opt))
    {
        if (widget)
        {
            ...
            if (id != QdfOfficePaintManager::Icon_Check)
            {
                ...
                drawIcon(p, rect, id, enabled ? QdfOfficePaintManager::Black : QdfOfficePaintManager::Gray);
...
void QdfOfficePaintManager::drawMenuItemSeparator(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
    QDF_D_STYLE(const QdfOfficeStyle)
...
void QdfOfficePaintManager::drawRectangle(QPainter *p, const QRect &rect, bool selected, bool pressed, bool enabled,
...
bool QdfOfficePaintManager::pixelMetric(QStyle::PixelMetric pm, const QStyleOption *opt, const QWidget *w, int &ret) const
{
    Q_UNUSED(opt);
    Q_UNUSED(w);
    switch (pm)
...
QdfOfficePaintManager::ImageState QdfOfficePaintManager::stateByColor(const QColor &color, bool backgroundColor) const
{
    if (!color.isValid())
    {
        return Black;
...
void QdfOfficePaintManager::drawIcon(QPainter *p, const QRect &rectImage, ImageIcons index, ImageState state,
...
QPixmap QdfOfficePaintManager::mapTo3dColors(const QPixmap &px, const QColor &clrSrc, const QColor &clrDest) const
{
