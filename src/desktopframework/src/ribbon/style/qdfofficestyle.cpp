...
bool QdfOfficeStylePrivate::isScrollBarsIgnored() const { return m_ignoreScrollBars; }
...
QdfOfficeStyle::QdfOfficeStyle(QdfOfficeStylePrivate *d) : QdfCommonStyle(d) { d->initialization(); }
...
int QdfOfficeStyle::getDPIToPercent() const { return isDPIAware() ? QdfDrawHelpers::getDPIToPercent() : 100; }
...
static bool isParentDialog(const QWidget *widget) { return widget && topLevelParentWidget(widget) != nullptr; }
...
void QdfOfficeStyle::unpolish(QApplication *app) { QdfCommonStyle::unpolish(app); }
...
bool QdfOfficeStyle::isStyle2010() const { return false; }
...
QSize QdfOfficeStyle::sizeFromContents(ContentsType ct, const QStyleOption *opt, const QSize &contentsSize,
                              ...
                              QStyleHintReturn *returnData) const
{
    ...
    switch (hint)
    {
        ...
        case SH_Table_GridLineColor:
            return opt ? d->m_clrGridLineColor.rgb() : QdfCommonStyle::styleHint(hint, opt, widget, returnData);
            ;
            break;
...
QStyle::SubControl QdfOfficeStyle::hitTestComplexControl(ComplexControl control, const QStyleOptionComplex *opt,
...
void QdfOfficeStyle::drawPrimitive(PrimitiveElement element, const QStyleOption *option, QPainter *painter,
                                   const QWidget *widget) const
{
...
QIcon QdfOfficeStyle::standardIconEx(StandardPixmap px, const QStyleOption *opt, const QWidget *wd, bool &ret) const
{
    QDF_D(const QdfOfficeStyle);
...
bool QdfOfficeStyle::drawIndicatorMenuCheckMark(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    QDF_D(const QdfOfficeStyle)
...
bool QdfOfficeStyle::drawGroupControlEntry(const QStyleOption *, QPainter *, const QWidget *) const { return false; }
...
bool QdfOfficeStyle::drawIndicatorToolBarSeparator(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    QDF_D(const QdfOfficeStyle);
...
bool QdfOfficeStyle::drawIndicatorCheckRadioButton(PrimitiveElement element, const QStyleOption *option, QPainter *painter,
                                                   const QWidget *widget) const
{
...
bool QdfOfficeStyle::drawIndicatorViewItemCheck(PrimitiveElement element, const QStyleOption *option, QPainter *painter,
                                                const QWidget *widget) const
{
    QDF_D(const QdfOfficeStyle);
...
bool QdfOfficeStyle::drawFrameDefaultButton(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
    Q_UNUSED(opt);
    Q_UNUSED(p);
    Q_UNUSED(widget);
...
bool QdfOfficeStyle::drawIndicatorToolBarHandle(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    Q_UNUSED(w);
    QDF_D(const QdfOfficeStyle)
...
// docksplitter
bool QdfOfficeStyle::drawIndicatorDockWidgetResizeHandle(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    QDF_D(const QdfOfficeStyle);
...
bool QdfOfficeStyle::drawTabBarTabLabel(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
#if (QT_VERSION < QT_VERSION_CHECK(5, 7, 0))
...
bool QdfOfficeStyle::drawToolBoxTabLabel(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
#if (QT_VERSION < QT_VERSION_CHECK(5, 7, 0))
...
bool QdfOfficeStyle::drawPanelItemViewItem(const QStyleOption *opt, QPainter *p, const QWidget *widget) const
{
...
bool QdfOfficeStyle::drawIndicatorHeaderArrow(const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    QDF_D(const QdfOfficeStyle);
    return d->officePaintManager()->drawIndicatorHeaderArrow(opt, p, w);
}

bool QdfOfficeStyle::drawIndicatorArrow(PrimitiveElement pe, const QStyleOption *opt, QPainter *p, const QWidget *w) const
{
    QDF_D(const QdfOfficeStyle);
...
void QdfOfficeStyle::drawRectangle(QPainter *p, const QRect &rect, bool selected, bool pressed, bool enabled, bool checked,
...
void QdfOfficeStyle::drawSplitButtonPopup(QPainter *p, const QRect &rect, bool selected, bool enabled, bool popuped) const
{
    Q_UNUSED(p);
    Q_UNUSED(rect);
    Q_UNUSED(selected);
...
QColor QdfOfficeStyle::getTextColor(bool selected, bool pressed, bool enabled, bool checked, bool popuped, BarType barType,
...
bool QdfOfficeStyle::eventFilter(QObject *watched, QEvent *event) { return QdfCommonStyle::eventFilter(watched, event); }

QWidgetList QdfOfficeStyle::allWidgets() const { return qApp->allWidgets(); }
...
QStringList QdfOfficeStylePlugin::keys() const { return QStringList() << "QdfOfficeStyle"; }
