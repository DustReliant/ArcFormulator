...
QdfAutoHideDockContainer::QdfAutoHideDockContainer(QdfDockWidget *DockWidget, SideBarLocation area, QdfDockContainerWidget *parent)
    : QPushButton(parent)
{
    ...
    d->pLayout = new QBoxLayout(isHorizontalArea(area) ? QBoxLayout::TopToBottom : QBoxLayout::LeftToRight);
...
void QdfAutoHideDockContainer::setSideBarLocation(SideBarLocation sideBarLocation)
{
    ...
    d->pLayout->setDirection(isHorizontalArea(sideBarLocation) ? QBoxLayout::TopToBottom : QBoxLayout::LeftToRight);
