...
void QdfDockManagerPrivate::loadStylesheet()
{
    ...
    FileName += QdfDockManager::testConfigFlag(QdfDockManager::FocusHighlighting)
                        ? "focus_highlighting"
                        : "default";
#if defined(Q_OS_UNIX) && !defined(Q_OS_MACOS)
    FileName += "_linux";
...
QdfDockManager::QdfDockManager(QWidget *parent)
    : QdfDockContainerWidget(this, parent)
{
...
QdfDockAreaWidget *QdfDockManager::addDockWidget(DockWidgetArea area,
                                                 QdfDockWidget *dockWidget, QdfDockAreaWidget *dockAreaWidget, int index)
{
    QDF_D(QdfDockManager)
    d->dockWidgetsMap.insert(dockWidget->objectName(), dockWidget);
...
QdfAutoHideDockContainer *QdfDockManager::addAutoHideDockWidget(SideBarLocation area, QdfDockWidget *dockWidget)
{
    return addAutoHideDockWidgetToContainer(area, dockWidget, this);
}

QdfAutoHideDockContainer *QdfDockManager::addAutoHideDockWidgetToContainer(SideBarLocation area, QdfDockWidget *dockWidget,
...
QdfDockAreaWidget *QdfDockManager::addDockWidgetTab(DockWidgetArea area,
...
QAction *QdfDockManager::addToggleViewActionToMenu(QAction *ToggleViewAction,
