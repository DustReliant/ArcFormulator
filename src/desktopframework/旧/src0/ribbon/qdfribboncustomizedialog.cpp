...
QWidget *QdfRibbonCustomizePageWidget::content() const { return m_content; }
...
void QdfRibbonCustomizeDialogPrivate::setCustomizeMode(bool edit)
{
    ...
    {
        if (QdfRibbonBarCustomizePage *page = qobject_cast<QdfRibbonBarCustomizePage *>(m_listWidget.at(index)))
        {
...
void QdfRibbonCustomizeDialogPrivate::insertPage(int index, QdfRibbonCustomizePageWidget *page)
{
    ...
    QdfRibbonCustomizePageItem *posItem = dynamic_cast<QdfRibbonCustomizePageItem *>(m_listPage->item(index));
...
void QdfRibbonCustomizeDialogPrivate::switchToPage(int currentRow)
{
    ...
    {
        if (QdfRibbonCustomizePageItem *item = dynamic_cast<QdfRibbonCustomizePageItem *>(m_listPage->item(m_currentPage)))
        {
...
QdfRibbonCustomizeDialog::~QdfRibbonCustomizeDialog() { QDF_FINI_PRIVATE(); }
...
void QdfRibbonCustomizeDialog::setCurrentPageIndex(int index)
{
    ...
    if (QdfRibbonCustomizePageItem *posItem = dynamic_cast<QdfRibbonCustomizePageItem *>(d->m_listPage->item(index)))
    {
        if (posItem->m_page)
        {
