...
QSize QdfStatusButton::sizeHint() const { return QToolButton::sizeHint(); }
...
QdfRibbonStatusBarSwitchGroup::~QdfRibbonStatusBarSwitchGroup() { QDF_FINI_PRIVATE(); }
...
/* QdfRibbonStatusBar */
QdfRibbonStatusBar::QdfRibbonStatusBar(QWidget *parent) : QStatusBar(parent) { QDF_INIT_PRIVATE(QdfRibbonStatusBar); }

QdfRibbonStatusBar::~QdfRibbonStatusBar() { QDF_FINI_PRIVATE(); }
...
void QdfRibbonStatusBar::paintEvent(QPaintEvent *event) { QStatusBar::paintEvent(event); }
