...
QdfStyleOptionPopupTitleBar::QdfStyleOptionPopupTitleBar() : QStyleOptionTitleBar(Version) {}


QdfPopupDrawHelper::QdfPopupDrawHelper() { m_fontBold = true; }

QdfPopupDrawHelper::~QdfPopupDrawHelper() {}

void QdfPopupDrawHelper::polish(QWidget *widget)
{
...
QRect QdfPopupDrawHelper::subControlRect(ComplexControl control, const QStyleOptionComplex *opt, SubControl subControl,
                                         const QWidget *widget) const
{
    ...
    {
        case CC_TitleBar:
            if (const QdfStyleOptionPopupTitleBar *bar = qstyleoption_cast<const QdfStyleOptionPopupTitleBar *>(opt))
            {
                ...
                switch (subControl)
                {
                    case SC_TitleBarLabel:
                        {
                            ...
                            if (bar->subControls & SC_TitleBarCloseButton)
                            {
                                ...
                                labelRect.adjust(bar->subControls & SC_TitleBarSysMenu ? delta : controlMargin, 0, -ir.width(),
                                                 controlMargin);
                            }
                            else
                            {
                                labelRect.adjust(bar->subControls & SC_TitleBarSysMenu ? delta : controlMargin, 0, controlMargin,
                                                 controlMargin);
                            }
                            rect = labelRect;
                            break;
                    ...
                    case SC_TitleBarSysMenu:
                        {
                            QRect rc = opt->rect;
                            rc.setRect(bar->rect.left() + controlMargin, bar->rect.top() + controlMargin, controlHeight,
                                       controlHeight);
                            rect = rc;
                            break;
                        }
...
int QdfPopupDrawHelper::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    Q_UNUSED(option);
    Q_UNUSED(widget);
    int value = 0;
...
QStyle::SubControl QdfPopupDrawHelper::hitTestComplexControl(ComplexControl control, const QStyleOptionComplex *opt,
                                                             const QPoint &pt, const QWidget *widget) const
{
    ...
    switch (control)
    {
        case CC_TitleBar:
            {
                const QdfStyleOptionPopupTitleBar *bar = qstyleoption_cast<const QdfStyleOptionPopupTitleBar *>(opt);
...
void QdfPopupDrawHelper::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt, QPainter *p,
                                            const QWidget *widget) const
{
    switch (cc)
    {
        case CC_TitleBar:
            if (const QdfStyleOptionPopupTitleBar *tb = qstyleoption_cast<const QdfStyleOptionPopupTitleBar *>(opt))
            {
                QRect rect = tb->rect;
                ...
                p->setPen(m_clrText);
                p->drawText(
                        labelRect, Qt::AlignLeft | Qt::AlignVCenter | Qt::TextSingleLine,
...
void QdfPopupDrawHelper::drawPrimitive(PrimitiveElement element, const QStyleOption *option, QPainter *p,
                                       const QWidget *widget) const
{
    switch (element)
    {
        case PE_FrameWindow:
            if (const QStyleOptionFrame *optFrame = qstyleoption_cast<const QStyleOptionFrame *>(option))
            {
                ...
                QdfDrawHelpers::drawGradientFill(*p, rect,
...
void QdfPopupDrawHelper::refreshPalette()
{
    m_fontBold = true;
...
/*!
    \class Qdf::PopupOffice2000DrawHelper
    \internal
*/
...
PopupOffice2000DrawHelper::~PopupOffice2000DrawHelper() {}
/*
void PopupOffice2000DrawHelper::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt, QPainter *p, const
...
int PopupOffice2000DrawHelper::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    ...
    switch (metric)
    {
        case PM_TitleBarHeight:
            ...
            break;
        default:
            value = QdfPopupDrawHelper::pixelMetric(metric);
    }
    return value;
}

void PopupOffice2000DrawHelper::drawPrimitive(PrimitiveElement element, const QStyleOption *option, QPainter *p,
                                              const QWidget *widget) const
{
    switch (element)
    {
        case PE_FrameWindow:
            if (const QStyleOptionFrame *optFrame = qstyleoption_cast<const QStyleOptionFrame *>(option))
            {
                ...
                QdfDrawHelpers::drawGradientFill(*p, rect, m_palBackground.window().color(),
                                                 m_palBackground.window().color(), true);
                QdfDrawHelpers::draw3DRect(*p, m_palFrame.shadow().color(), m_palFrame.shadow().color(), rect.x(), rect.y(),
                ...
                QdfDrawHelpers::drawGradientFill(*p, rcBackground, QColor(0, 0, 128), QColor(24, 180, 192), false);
                ...
                QdfDrawHelpers::draw3DRect(*p, m_palFrame.shadow().color(), m_palFrame.shadow().color(), rcBackground.x(),
                                           rcBackground.y(), rcBackground.width() - 1, rcBackground.height() - 1, false);

                rcBackground.adjust(1, 1, -1, -1);
                rcBackground.setRight(rcBackground.left() + 30);
                QdfDrawHelpers::drawGradientFill(*p, rcBackground, QColor(0, 0, 128), QColor(0, 0, 128), true);
...
/*!
    \class Qdf::PopupOffice2003DrawHelper
    \internal
*/
PopupOffice2003DrawHelper::PopupOffice2003DrawHelper() { setDecoration(OS_SYSTEMBLUE); }

PopupOffice2003DrawHelper::~PopupOffice2003DrawHelper() {}

void PopupOffice2003DrawHelper::polish(QWidget *widget)
{
    QdfPopupDrawHelper::polish(widget);
...
PopupOffice2003DrawHelper::OptionsStyle PopupOffice2003DrawHelper::getDecoration() const { return m_styleType; }

QRect PopupOffice2003DrawHelper::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
                                                SubControl subControl, const QWidget *widget) const
{
    QRect rect = QdfPopupDrawHelper::subControlRect(control, option, subControl, widget);

    switch (control)
    {
        case CC_TitleBar:
            if (const QdfStyleOptionPopupTitleBar *bar = qstyleoption_cast<const QdfStyleOptionPopupTitleBar *>(option))
            {
                switch (subControl)
                {
                    case SC_TitleBarLabel:
...
void PopupOffice2003DrawHelper::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt, QPainter *p,
                                                   const QWidget *widget) const
{
    switch (cc)
    {
        case CC_TitleBar:
            if (const QdfStyleOptionPopupTitleBar *tb = qstyleoption_cast<const QdfStyleOptionPopupTitleBar *>(opt))
            {
                ...
                QdfDrawHelpers::drawGradientFill(*p, rcGripper, m_palGripper.color(QPalette::Light),
                                                 m_palGripper.color(QPalette::Dark), true);
        ...
        case CC_ToolButton:
            ...
            break;
        default:
            QdfPopupDrawHelper::drawComplexControl(cc, opt, p, widget);
    }
}

void PopupOffice2003DrawHelper::drawPrimitive(PrimitiveElement element, const QStyleOption *option, QPainter *p,
                                              const QWidget *widget) const
{
    switch (element)
    {
        ...
        case PE_FrameWindow:
            ...
            {
                QRect rect = optFrame->rect;
                QdfDrawHelpers::drawGradientFill(*p, rect, m_palBackground.color(QPalette::Light),
                                                 m_palBackground.color(QPalette::Dark), true);
                QdfDrawHelpers::draw3DRect(*p, m_palFrame.color(QPalette::Light), m_palFrame.color(QPalette::Dark), rect.x(),
                                           rect.y(), rect.width() - 1, rect.height() - 1, false);
                break;
            }
            // fallthrough
        default:
            QdfPopupDrawHelper::drawPrimitive(element, option, p, widget);
    }
}

void PopupOffice2003DrawHelper::refreshPalette()
{
    QdfPopupDrawHelper::refreshPalette();
        ...
        case OS_SYSTEMWHITE:
            {
                ...
                m_clrButtonSelected = QdfDrawHelpers::colorMakePale(color.rgb(), .9);
                m_clrButtonPressed = QdfDrawHelpers::colorMakeDarker(m_clrButtonSelected.rgb(), .14);
...
/*!
    \class Qdf::PopupOffice2007DrawHelper
    \internal
*/
PopupOffice2007DrawHelper::PopupOffice2007DrawHelper() { m_helper = new QdfStyleHelper(this); }
...
/*!
    \class Qdf::PopupOffice2010DrawHelper
    \internal
*/
...
void PopupMSNDrawHelper::drawPrimitive(PrimitiveElement element, const QStyleOption *option, QPainter *p,
                                       const QWidget *widget) const
{
    switch (element)
    {
        case PE_FrameWindow:
            if (const QStyleOptionFrame *optFrame = qstyleoption_cast<const QStyleOptionFrame *>(option))
            {
                ...
                QdfDrawHelpers::draw3DRect(*p, QColor(166, 180, 207), QColor(69, 86, 144), rect.x(), rect.y(),
                                           rect.width() - 1, rect.height() - 1, true);
                rect.adjust(1, 1, -1, -1);
                QdfDrawHelpers::draw3DRect(*p, QColor(255, 255, 255), QColor(207, 222, 244), rect.x(), rect.y(),
                                           rect.width() - 1, rect.height() - 1, true);
                rect.adjust(1, 1, -1, -1);
                ...
                QdfDrawHelpers::drawGradientFill(*p, rcBackground, QColor(207, 215, 236), QColor(255, 255, 255), true);

                rcBackground.setHeight(titleBarHeight + 1);
                QdfDrawHelpers::drawGradientFill(*p, rcBackground, QColor(255, 255, 255), QColor(207, 221, 244), true);

                rcBackground.setHeight(40);
                QdfDrawHelpers::drawGradientFill(*p, rcBackground, QColor(207, 221, 244), QColor(255, 255, 255), true);
                ...
                QdfDrawHelpers::draw3DRect(*p, QColor(114, 142, 184), QColor(185, 201, 239), rcFrame.x(), rcFrame.y(),
                                           rcFrame.width() - 1, rcFrame.height() - 1, true);
                break;
            }
            // fallthrough
        default:
